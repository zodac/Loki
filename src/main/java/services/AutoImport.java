...
@Stateless
@Local
public class AutoImport implements AutoImportService{
	...
	public int[] addToDatabase(File uploadedFile, String fileExtension){
		System.out.println("Starting import, again");
	...
	private boolean parseEventCauseCells(Iterator<Cell> cellIterator) {
    	...
    	System.out.println("Trying to persist EC");
