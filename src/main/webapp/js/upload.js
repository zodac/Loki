$('#upload').ajaxForm({
	...
	error : function(error) {
		...
		cell.appendChild(document
				.createTextNode("Call Failures added"));
		row.appendChild(cell);
		...
		cell
				.appendChild(document
						.createTextNode("Event/Cause combinations added"));
		row.appendChild(cell);
		tbody.appendChild(row);
		...
		cell = document.createElement("td");
		cell.appendChild(document
				.createTextNode("Failure Classes added"));
		row.appendChild(cell);
		tbody.appendChild(row);
		...
		cell
				.appendChild(document
						.createTextNode("Call Failures removed due to inconsistencies"));
		row.appendChild(cell);
		tbody.appendChild(row);
