...
<div class="col-md-9 text-center">
	<h4 class="col-md-offset-2 col-md-7 text-center"><%=Strings.TOP_10_IMSIS%></h4>
	<br /> <br /> <br />
	<form name="nmequery" id="nmequery"
		...
		<div class="form-group">
			<div class="col-md-1">
				...
				<span style="display:inline"><input class="btn btn-primary" type="button" onclick="topIMSIs()" value="<%=Strings.SUBMIT%>" /></span>
